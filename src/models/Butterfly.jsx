...
/*
1. Open integrated terminal on public butterfly folder
2. Paste script (from https://github.com/pmndrs/gltfjsx)
   npx gltfjsx model.gltf --transform
   in terminal and change model.glft to scene.gltf
   to match model name from sketchfab
3. After Scene.jsx and scene-transfromed.glb are created in
   public folder, move Scene.jsx to a new folder called models in the src directory and rename if desired
4. Update relative path to point to the public glb file
*/

import React, { useEffect, useRef } from 'react'
import { useGLTF, useAnimations } from '@react-three/drei'

// Update name from Model to Butterfly
export function Butterfly(props) {
  const group = useRef()
  // Update path to public/models/butterfly/glb file
